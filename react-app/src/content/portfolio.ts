// Generated from ../portfolio-content.js (single source of truth for copy). Regenerate with npm run sync-assets.
export const content = {
  "seo": {
    "en": {
      "defaultTitle": "Tianlu Zhang | Principal AI/ML Engineer",
      "description": "Principal AI and full-stack engineer with 12 years across Apple and Intel, specializing in LLM platforms, distributed systems, MLOps and engineering leadership.",
      "aboutTitle": "About | Tianlu Zhang",
      "workTitle": "Selected Work | Tianlu Zhang"
    },
    "fr": {
      "defaultTitle": "Tianlu Zhang | Ingénieur principal IA/ML",
      "description": "Ingénieur principal en IA et full-stack avec 12 ans d’expérience chez Apple et Intel, spécialisé dans les plateformes LLM, les systèmes distribués, le MLOps et le leadership technique.",
  ...
  "home": {
    "en": {
      "summary": "Tianlu Zhang is a Principal AI and full-stack engineer with 12 years spanning Apple and Intel, leading teams building distributed LLM and MLOps platforms, accelerating delivery, reducing risk and turning ambitious startup ideas into market advantage.",
    ...
    "fr": {
      "summary": "Tianlu Zhang est ingénieur principal en IA et full-stack, avec 12 ans d’expérience chez Apple et Intel. Il dirige des équipes qui conçoivent des plateformes distribuées de LLM et de MLOps, accélèrent la livraison, réduisent les risques et transforment des idées ambitieuses en avantage concurrentiel.",
      ...
      "expertise": [
        {
          ...
          "description": "Designing scalable platforms for model training, fine-tuning, evaluation and real-time inference, with robust architecture across compute, data, APIs and observability."
        },
        {
          "heading": "Full-Stack AI Products",
          "word": "PRODUCTS",
          "icon": "/images/expertise/products.svg",
          "description": "Building production LLM applications, intelligent workflows and user-facing AI products that connect reliable backend services with intuitive full-stack experiences."
        },
        {
          "heading": "Distributed Systems",
          "word": "SYSTEMS",
          "icon": "/images/expertise/systems.svg",
          "description": "Engineering high-throughput, low-latency services and data pipelines that remain reliable under demanding workloads and scale efficiently as products grow."
        },
        {
          "heading": "MLOps & Reliability",
          "word": "RELIABILITY",
          "icon": "/images/expertise/reliability.svg",
          "description": "Creating repeatable systems for experimentation, deployment, monitoring and governance—reducing release time, infrastructure cost and production risk."
        },
        {
          "heading": "Technical Leadership",
          "word": "LEADERSHIP",
          "icon": "/images/expertise/leadership.svg",
          "description": "Setting technical direction, leading multidisciplinary teams and turning ambiguous business goals into focused roadmaps, decisive execution and measurable outcomes."
        }
      ]
    },
    "fr": {
      ...
      "expertise": [
        {
          ...
          "word": "PLATEFORMES",
          "icon": "/images/expertise/platforms.svg",
          "description": "Conception de plateformes évolutives pour l’entraînement, le fine-tuning, l’évaluation et l’inférence en temps réel, avec une architecture robuste pour le calcul, les données, les API et l’observabilité."
        },
        {
          "heading": "Produits IA full-stack",
          "word": "PRODUITS",
          "icon": "/images/expertise/products.svg",
          "description": "Création d’applications LLM en production, de workflows intelligents et de produits IA qui relient des services backend fiables à des expériences full-stack intuitives."
        },
        {
          "heading": "Systèmes distribués",
          "word": "SYSTÈMES",
          "icon": "/images/expertise/systems.svg",
          "description": "Ingénierie de services et de pipelines de données à haut débit et faible latence, fiables sous forte charge et capables d’évoluer efficacement avec les produits."
        },
        {
          "heading": "MLOps et fiabilité",
          "word": "FIABILITÉ",
          "icon": "/images/expertise/reliability.svg",
          "description": "Création de systèmes reproductibles pour l’expérimentation, le déploiement, le monitoring et la gouvernance, afin de réduire les délais, les coûts d’infrastructure et les risques en production."
        },
        {
          "heading": "Leadership technique",
          "word": "LEADERSHIP",
          "icon": "/images/expertise/leadership.svg",
          "description": "Définition de la direction technique, pilotage d’équipes pluridisciplinaires et transformation d’objectifs ambigus en feuilles de route ciblées, exécution décisive et résultats mesurables."
        }
      ]
    }
  },
      ...
      "cases": [
        {
          ...
          "short": "Architected shared training and inference infrastructure supporting 40+ production and experimental models across eight engineering organizations and 120+ ML and software engineers.",
          "detail": [
        ...
        },
        {
          ...
          "short": "Reduced p95 inference latency by 41%, increased effective throughput 2.3× and lowered average infrastructure cost by 31%.",
          "detail": [
        ...
        },
        {
          ...
          "category": "llm-systems",
          "short": "Built repeatable fine-tuning infrastructure across clusters of 64+ accelerators while shortening turnaround by 43%.",
          "detail": [
        ...
        },
        {
          ...
          "category": "llm-systems",
          "short": "Trained embedding models on 180M+ semantic pairs, improving Recall@50 by 12.6% and NDCG@10 by 9.8%.",
          "detail": [
        ...
        },
        {
          ...
          "category": "ai-platforms",
          "short": "Reduced model productionization from approximately 14 days to five through reusable MLOps infrastructure.",
          "detail": [
        ...
        },
        {
          ...
          "short": "Led a Redis-based platform sustaining 250K+ peak requests per second at under 6 ms p99 latency and 99.995% availability.",
          "detail": [
        ...
        },
        {
          ...
          "category": "leadership",
          "short": "Managed 12 engineers across PlaceCard and Reverse Geocoding while coordinating delivery with eight partner teams.",
          "detail": [
        ...
        },
        {
          ...
          "category": "distributed-systems",
          "short": "Connected machine-learning research with systems architecture and production performance engineering at Intel.",
          "detail": [
      ...
      "cases": [
        {
          ...
          "short": "Architecture d’une infrastructure partagée d’entraînement et d’inférence pour plus de 40 modèles en production et expérimentaux, au service de huit organisations d’ingénierie et de plus de 120 ingénieurs ML et logiciel.",
          "detail": [
        ...
        },
        {
          ...
          "short": "Réduction de 41% de la latence p95, multiplication par 2,3 du débit effectif et baisse de 31% du coût moyen d’infrastructure.",
          "detail": [
        ...
        },
        {
          ...
          "category": "systemes-llm",
          "short": "Création d’une infrastructure reproductible de fine-tuning sur des clusters de plus de 64 accélérateurs, avec un délai réduit de 43%.",
          "detail": [
        ...
        },
        {
          ...
          "category": "systemes-llm",
          "short": "Entraînement de modèles d’embeddings sur plus de 180 millions de paires sémantiques, améliorant Recall@50 de 12,6% et NDCG@10 de 9,8%.",
          "detail": [
        ...
        },
        {
          ...
          "category": "plateformes-ia",
          "short": "Réduction du passage des modèles en production d’environ 14 jours à cinq grâce à une infrastructure MLOps réutilisable.",
          "detail": [
        ...
        },
        {
          ...
          "short": "Pilotage d’une plateforme Redis dépassant 250 000 requêtes par seconde en pointe, avec une latence p99 inférieure à 6 ms et une disponibilité de 99,995%.",
          "detail": [
        ...
        },
        {
          ...
          "category": "leadership",
          "short": "Management de 12 ingénieurs sur PlaceCard et Reverse Geocoding, avec coordination de la livraison auprès de huit équipes partenaires.",
          "detail": [
        ...
        },
        {
          ...
          "category": "systemes-distribues",
          "short": "Mise en relation de la recherche en machine learning, de l’architecture système et de l’ingénierie de performance en production chez Intel.",
          "detail": [
